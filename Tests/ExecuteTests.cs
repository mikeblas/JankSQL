...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public void TestSelectExpressionSquareRoot()
        {
            ...
            for (int i = 0; i < result.ResultSet.RowCount; i++)
                Assert.That(result.ResultSet.Row(i)[0].AsDouble(), Is.EqualTo(1.41421356).Within(0.00000001));
        }
        ...
        public void TestTwoResults()
        {
            ...
            Assert.That(results.Length, Is.EqualTo(2), "expected two results");
        ...
        public void TestIIF()
        {
            ...
            for (int i = 0; i < result.ResultSet.RowCount; i++)
            {
                ...
                if (num % 2 == 0)
                    Assert.That(second, Is.EqualTo("Even"));
                else
                    Assert.That(second, Is.EqualTo("Odd"));
            }
        }
        ...
        public void TestIIFPredicate()
        {
            ...
            {
                int num = result.ResultSet.Row(i)[0].AsInteger();
                Assert.That(num % 2, Is.Zero, "expected only even numbers");
            }
        }
