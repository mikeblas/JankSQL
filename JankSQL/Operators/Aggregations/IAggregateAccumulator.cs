namespace JankSQL.Operators.Aggregations
{
    ...
    /// aggregate, and then asked for a FinalValue after the end of the row set.
    /// </summary>
    internal interface IAggregateAccumulator
    {
        /// <summary>
        /// Accepts a value to accumulate in an aggregation. Called once per row within a grouping.
        /// </summary>
